    ...
    <div className="min-h-screen bg-[#0f0b1a] p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Sobre o DataCrim</h1>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#1a1625] rounded-3xl p-6 border border-[#2b2438]">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-12 h-12 rounded-xl bg-[#4aa3ff]/20 flex items-center justify-center flex-shrink-0">
                <Shield className="w-6 h-6 text-[#4aa3ff]" />
              </div>
              <div>
                <h2 className="text-xl font-semibold text-white mb-2">Nossa Missão</h2>
                <p className="text-muted-foreground leading-relaxed">
                  O DataCrim é uma plataforma inovadora que conecta cidadãos e autoridades policiais, facilitando o
          ...
          <div className="bg-[#1a1625] rounded-3xl p-6 border border-[#2b2438]">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-[#4aa3ff] mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#4aa3ff] mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Brain className="w-5 h-5 text-[#4aa3ff] mt-1 flex-shrink-0" />
                <div>
          ...
          <div className="bg-[#1a1625] rounded-3xl p-6 border border-[#2b2438]">
            <h2 className="text-xl font-semibold text-white mb-3">Privacidade e Segurança</h2>
            <p className="text-muted-foreground leading-relaxed">
