      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="grid gap-4 mb-8">
          ...
          <div className={`${cardBg} rounded-2xl p-5 border ${borderColor}`}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#4aa3ff]/20 flex items-center justify-center flex-shrink-0">
                <MessageCircle className="w-6 h-6 text-[#4aa3ff]" />
              </div>
          ...
          <div className={`${cardBg} rounded-2xl p-5 border ${borderColor}`}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#4aa3ff]/20 flex items-center justify-center flex-shrink-0">
                <Mail className="w-6 h-6 text-[#4aa3ff]" />
              </div>
              <div className="flex-1">
                <h3 className={`${textColor} font-semibold mb-1`}>{t("emailSupport")}</h3>
                <p className={`${mutedColor} text-sm mb-3`}>{t("emailSupportDesc")}</p>
                <a href="mailto:suporte@datacrim.com">
                  <Button variant="outline" className={theme === "light" ? "border-gray-300" : ""}>
                    {t("sendEmail")}
                  </Button>
                </a>
              </div>
          ...
          <div className={`${cardBg} rounded-2xl p-5 border ${borderColor}`}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#4aa3ff]/20 flex items-center justify-center flex-shrink-0">
                <Phone className="w-6 h-6 text-[#4aa3ff]" />
              </div>
              <div className="flex-1">
        ...
        <div className={`${cardBg} rounded-3xl p-6 border ${borderColor} mb-6`}>
          <div className="flex items-center gap-3 mb-4">
            <Send className="w-5 h-5 text-[#4aa3ff]" />
        ...
        <div className={`${cardBg} rounded-2xl p-5 border ${borderColor} text-center`}>
          <div className="flex items-center justify-center gap-2 mb-2">
            <Clock className="w-5 h-5 text-[#4aa3ff]" />
