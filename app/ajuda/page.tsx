  ...
  return (
    <div className="min-h-screen bg-[#0f0b1a] p-6">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Emergency Contact */}
        <div className="bg-gradient-to-r from-[#4aa3ff] to-[#2b6ef6] rounded-3xl p-6 mb-6">
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="bg-[#1a1625] rounded-2xl p-5 border border-[#2b2438]">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-[#4aa3ff]/20 flex items-center justify-center flex-shrink-0">
                  <faq.icon className="w-5 h-5 text-[#4aa3ff]" />
                </div>
